...
// checks for which method to call first
		...
		if(input.startsWith("hey")||
			...
			return Question(input);
               else if (input.contains("politics"))
                    return politics(input);
               else if (input.contains("democ"))
                    return politics(input);
               else if (input.contains("President"))
                    return politics(input);
               else if (input.contains("influence"))
                    return politics(input);
               else if (input.contains("rule"))
                    return politics(input);
	...
	public static String politics(String input){
            String a="";
        
        if(input.contains("President"))
			a="I prefer Anarchy";
		else if(input.contains("rule"))
                {a="Join the dark side, and you will have all the powers.";}
                else if(input.contains("Hitler"))
                {a="Hitler is one admirable leader of mankind's history.";}
            ...
            switch(i)
            {
                case 1: a= "The dark side will be your future.";
                    break;
                case 2: a= "I find your lack of faith disturbing. We want you, to join the Dark side.";
                    break;
            }
        }
        return a;
...
// it calls the adequate method else returns a generic answer
	...
	public static String Where(String input){
	...
	public static String How(String input){
		String a="";
	...
	public static String What(String input){
		String a="";
	...
	public static String Why(String input){
		String a="";
		if(input.contains("cape"))
			...
			a="Trust me, you do not want to see the real me.";
                else if (input.contains("fatherhood"))
                    a= "I have always wanted to be a good father. ";
		else {
			Random generator = new Random();
			int i=generator.nextInt(3)+1;
	...
	public static String When(String input){
		String a="";
	...
	public  static String Question(String input){
        ...
        case 10: a = "Never.";
                 break;
        case 11: a= "Is that a question?";
        break;
        case 12: a= "Nonono, I will not answer that question!";
                break;
        case 13: a= "NOOOOOOOOOOOOOOOOOOOO";
            break;
    }}
   return a;}
		
	
	public  static String generic(String input){ 
